...
################################################################
# This is a generated script based on design: CNN_imp
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__ACT_DDR_FREQ_MHZ {500.000000} \
   ...
   CONFIG.PSU__CRF_APB__DDR_CTRL__ACT_FREQMHZ {250.000000} \
   CONFIG.PSU__CRF_APB__DDR_CTRL__DIVISOR0 {6} \
  ...
  connect_bd_intf_net -intf_net CNN_DMA_M_AXIS_MM2S [get_bd_intf_pins CNN_DMA/M_AXIS_MM2S] [get_bd_intf_pins mlp_0/in_r]
  connect_bd_intf_net -intf_net CNN_DMA_M_AXI_S2MM [get_bd_intf_pins CNN_DMA/M_AXI_S2MM] [get_bd_intf_pins axi_smc/S01_AXI]
  connect_bd_intf_net -intf_net S00_AXI_1 [get_bd_intf_pins ps7_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins CNN_DMA/M_AXI_MM2S] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_intf_net -intf_net mlp_0_out_r [get_bd_intf_pins CNN_DMA/S_AXIS_S2MM] [get_bd_intf_pins mlp_0/out_r]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins CNN_DMA/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins CNN_DMA/m_axi_mm2s_aclk] [get_bd_pins CNN_DMA/m_axi_s2mm_aclk] [get_bd_pins CNN_DMA/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins mlp_0/ap_clk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins CNN_DMA/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins mlp_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
