...
HD_PWD='F:/CNNproj/Ultra96/FPGA/Vivado_synthesis/Vivado_implementation.runs/CNN_imp_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CNN_imp_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CNN_imp_rst_ps7_0_100M_0.tcl
