...
HD_PWD='F:/CNNproj/Ultra96/FPGA/Vivado_synthesis/Vivado_implementation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CNN_imp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CNN_imp_wrapper.tcl -notrace
