...
architecture rtl of mlp_weights_2_ram is 
...
architecture arch of mlp_weights_2 is
    component mlp_weights_2_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_weights_2_ram_U :  component mlp_weights_2_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
