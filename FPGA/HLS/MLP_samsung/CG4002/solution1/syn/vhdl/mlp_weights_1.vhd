...
architecture rtl of mlp_weights_1_ram is 
...
architecture arch of mlp_weights_1 is
    component mlp_weights_1_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_weights_1_ram_U :  component mlp_weights_1_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
