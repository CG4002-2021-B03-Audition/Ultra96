...
entity mlp_weights_1_V_ram is 
    generic(
            DWIDTH     : integer := 12; 
            AWIDTH     : integer := 16; 
            MEM_SIZE    : integer := 44096
    ); 
    port (
...
architecture rtl of mlp_weights_1_V_ram is 
...
entity mlp_weights_1_V is
    generic (
        DataWidth : INTEGER := 12;
        AddressRange : INTEGER := 44096;
...
architecture arch of mlp_weights_1_V is
    component mlp_weights_1_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_weights_1_V_ram_U :  component mlp_weights_1_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
