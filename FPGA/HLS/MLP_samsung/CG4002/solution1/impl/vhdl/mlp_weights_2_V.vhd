...
architecture rtl of mlp_weights_2_V_ram is 
...
architecture arch of mlp_weights_2_V is
    component mlp_weights_2_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    mlp_weights_2_V_ram_U :  component mlp_weights_2_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
