...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_r_TVALID { I 1 bit } in_r_TDATA { I 8 vector } in_r_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TREADY { I 1 bit } out_r_TDATA { O 8 vector } out_r_TVALID { O 1 bit } } \
} "
} else {
