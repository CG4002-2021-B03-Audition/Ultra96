...
// ==============================================================
#ifndef __mlp_dance3_fcmp_3pcA__HH__
#define __mlp_dance3_fcmp_3pcA__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mlp_dance3_fcmp_3pcA) {
    ...
    SC_CTOR(mlp_dance3_fcmp_3pcA):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
