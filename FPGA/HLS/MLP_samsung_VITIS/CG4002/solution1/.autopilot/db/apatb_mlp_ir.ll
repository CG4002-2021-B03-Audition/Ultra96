...
define void @apatb_mlp_ir(%"class.hls::stream"* %S_AXIS, %"class.hls::stream"* %M_AXIS) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mlp_hw(%"class.hls::stream"* %S_AXIS_copy, %"class.hls::stream"* %M_AXIS_copy)
...
; <label>:8:                                      ; preds = %copy
  ...
  %.01.15.gep7 = getelementptr %"class.hls::stream", %"class.hls::stream"* %0, i32 0, i32 0, i32 1
  %10 = bitcast i1* %.01.15.gep7 to i8*
  %.0.14.gep8 = getelementptr %"class.hls::stream", %"class.hls::stream"* %1, i32 0, i32 0, i32 1
  %11 = bitcast i1* %.0.14.gep8 to i8*
...
declare void @apatb_mlp_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @mlp_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @mlp_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @mlp_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
