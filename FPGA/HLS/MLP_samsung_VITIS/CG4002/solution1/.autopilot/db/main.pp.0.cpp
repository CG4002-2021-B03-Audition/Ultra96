...
# 38 "main.cpp"
__attribute__((sdx_kernel("mlp", 0))) void mlp(stream_type& S_AXIS, stream_type& M_AXIS) {
...
#pragma HLS INTERFACE axis port=M_AXIS
 float weights_0[561], bias[64+64+6];
    ...
    VITIS_LOOP_45_1: while (1) {
     AXI_L in, out;
     VITIS_LOOP_47_2: for (int j = 0; j < 561; j++) {
   in = S_AXIS.read();
   weights_0[j] = in.data;
     }
     VITIS_LOOP_51_3: for (int j = 0; j < 560; j++) {
